...
<template>
  ...
  <div
    class="w-full max-w-[280px] bg-white p-2.5 fixed top-0 z-9999 transition-all duration-300 after:block after:bg-green-600 after:h-1 after:w-full after:absolute after:bottom-0 after:left-0"
  ...
  >
    ...
    <ul>
      <li class="mb-2.5">
        <button
          class="block uppercase font-bold text-[16px] text-[#444]/60"
          @click="animeBtnHandler"
        >
          Анимэ
        </button>
      </li>
  ...
  <button
    class="block w-10 h-10 bg-red-500 cursor-pointer fixed z-9999 left-[280px] transition-all duration-300"
    :class="isMobileMenuOpen ? 'top-0' : '-top-40'"
    @click="$emit('close-mobile')"
  >
    <svg
      xmlns="http://www.w3.org/2000/svg"
